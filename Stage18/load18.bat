load --init ../expl/stage17/shell.xsm
rm odd.xsm
load --exec ../expl/stage14/odd.xsm
rm even.xsm
load --exec ../expl/stage14/even.xsm
rm prime.xsm
load --exec ../expl/stage14_1/prime.xsm
load --idle ../expl/stage14/idle.xsm
load --os ../spl/stage14/os_startup.xsm
load --int=timer ../spl/stage14/timer.xsm
load --module 7 ../spl/stage18/bootmodule.xsm
...
load --int=9 ../spl/stage18/int9.xsm
